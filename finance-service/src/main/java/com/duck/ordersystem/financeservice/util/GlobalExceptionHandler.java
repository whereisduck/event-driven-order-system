...
public class GlobalExceptionHandler {
  ...
  public Mono<ResponseEntity<ApiErrorResponse>> handleServiceApiException(ServiceApiException exception) {
    log.error("service api error: {}, {}", exception.getHttpStatusCode(), exception.getMessage(), exception);
    var responseEntity = ResponseEntity.status(exception.getHttpStatusCode())
